      ...
      <v-row class="pa-8 justify-center">
            ...
            <v-col cols="12">
              <v-window v-model="tab">
                <v-window-item value="tab-1">
                  <div>
                    <div class="text-center">
                      <h3 class="text-h3">Welcome to the Plexus</h3>
                ...
                <v-window-item value="tab-5">
                  ...
                  <v-btn variant="flat" to="/login" color="primary" block>Login</v-btn>
                </v-window-item>
              </v-window>
            </v-col>
          </v-row>
        ...
        <v-col cols="12" class="text-center">
          <p class="text-h6 mb-0">
            By signing up, you confirm to have read Plexus
            <a href="/pages/privacy-policy" class="text-primary">Privacy Policy</a>
            and agree to the
            <a href="/auth/login3" class="text-primary">Terms of Service</a>
            .
          </p>
        </v-col>
      </v-row>
