...
<template>
  <div class="home-bg">
        ...
        <v-col cols="12" lg="7" md="6" sm="8">
          <div class="pe-lg-4 homeContent text-center">
            <h1 class="bannerText mb-5" data-aos="fade-up" data-aos-duration="500">
              Pellenv Uns dof thi <span class="text-animation">Plexus</span> Liberoque ni Ullamcorper
            </h1>
            <p class="mb-8 text-h5 font-weight-regular" data-aos="fade-up" data-aos-duration="800">
              Plexus er vel tis enim tic Puruslig Nulla fringillam placerat posuere quam At nibhct torquenti sit amet 3.1P+ Placerat tortor.
            </p>
            <div data-aos="fade-up" data-aos-duration="1000">
              <v-btn variant="outlined" class="font-weight-medium ms-4" height="42px" color="white" rounded="md" href="/login" target="_">
                Try now
              </v-btn>
            </div>
          </div>
    ...
    <div class="technology" v-if="false">
