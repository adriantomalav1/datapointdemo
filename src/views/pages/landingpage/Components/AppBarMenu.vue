    ...
    <v-container class="fill-height maxWidth">
      <div class="d-flex align-center ga-2 w-100">
        ...
        <template v-if="mdAndUp">
          ...
          <v-menu v-if="false" v-model="isMenuOpen" :close-on-content-click="false">
          ...
          <v-btn variant="flat" class="font-weight-medium ms-4" height="42px" color="primary" rounded="md" href="/login" target="_">
