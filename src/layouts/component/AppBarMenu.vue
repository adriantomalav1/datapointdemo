    ...
    <v-container class="fill-height maxWidth">
      <div class="d-flex align-center ga-2 w-100">
        ...
        <template v-if="mdAndUp">
          <v-btn variant="text" class="font-weight-medium" to="/dashboard" target="_">Dashboard</v-btn>
        ...
        <template v-else>
          <v-btn variant="outlined" color="warning" rounded="md" to="/dashboard" target="_">Dashboard</v-btn>
